...
set_target_properties(Qt6::GlobalConfigPrivate PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/QtCore/6.1.2;${_IMPORT_PREFIX}/include/QtCore/6.1.2/QtCore"
...
set_target_properties(Qt6::PlatformCommonInternal PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<NOT:\$<CONFIG:Debug>>:QT_NO_DEBUG>;_CRT_SECURE_NO_WARNINGS;\$<\$<STREQUAL:\$<TARGET_PROPERTY:TYPE>,SHARED_LIBRARY>:_WINDLL>"
  INTERFACE_COMPILE_OPTIONS "-FS;-Zc:rvalueCast;-Zc:inline;-Zc:strictStrings;-Zc:throwingNew;-Zc:referenceBinding;-Zc:externConstexpr;-Zc:wchar_t;\$<\$<NOT:\$<CONFIG:Debug>>:-guard:cf>"
  INTERFACE_LINK_OPTIONS "-DYNAMICBASE;-NXCOMPAT;\$<\$<NOT:\$<CONFIG:Debug>>:-OPT:REF;-OPT:ICF;-GUARD:CF>"
)
